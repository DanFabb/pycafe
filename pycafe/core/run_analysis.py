...
def run_analysis(
    *,
    ...
    Passing ``elements`` (the mesh connectivity returned by the loader)
    lets the interactive post-processing of a 3D result use the 3D
    entries -- volume plots, cutting planes and movies -- instead of the
    2D ones.
    """
