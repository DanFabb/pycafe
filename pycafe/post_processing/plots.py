...
def plot_frf(frequencies, signals, *, resonances=None, annotate=3,
             band=None, title=None, figsize=None, show=False):
    """
...
def plot_modes(model, frequencies, pressure_shapes, *, structure_shapes=None,
    ...
    from .panel import describe_panel, plot_panel_mode
    from .post_processing_3d import extract_surface_faces, plot_pressure_3d
