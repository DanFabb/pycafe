...
:mod:`pycafe_vibro.coupling`, whose module documentation
...
pycafe_vibro.prepare_vibroacoustic_system : Builds the coupled system.
"""
    ...
    *,
    ...
    if system.get("coupling") is None:
        raise RuntimeError(
            ...
            "pycafe_vibro.coupling.build_coupling_matrix."
        )
