...
(:func:`~pycafe_vibro.solver_vibroacoustic.solve_vibroacoustic_frequency_sweep`),
...
----------------------------------------------------
The basis is made of the modes of the *whole* vibroacoustic system:
...
:func:`~pycafe_vibro.solver_vibroacoustic.coupled_modal_matrices`.)
...
See Also
--------
pycafe_vibro.solver_vibroacoustic : Direct coupled sweep and modes.
...
from .solver_vibroacoustic import (
    _as_sweep,
