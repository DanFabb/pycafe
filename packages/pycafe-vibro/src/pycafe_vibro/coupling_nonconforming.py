...
The conforming coupling of :mod:`pycafe_vibro.coupling` needs
...
See Also
--------
pycafe_vibro.coupling : Conforming coupling and sign convention.
"""
...
def fluid_boundary_faces(fluid_conn0):
    ...
    """
    from pycafe.build_matrices.faces import _VOLUME_FACES
...
def build_nonconforming_coupling(
    ...
    *,
    ...
    Kc : scipy.sparse.csr_matrix, shape (dofs_per_node * N, N)
        ...
        matrix of :func:`pycafe_vibro.coupling.build_coupling_matrix`,
