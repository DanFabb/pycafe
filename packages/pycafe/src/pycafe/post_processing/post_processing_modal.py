"""
Post-processing of an acoustic modal analysis.

Interactive selection and plotting of the acoustic mode shapes returned
by :func:`pycafe.solver.solver_modale.solve_modal_acoustic_reduced`.
The modes come out of the solver on the reduced system and are expanded
back onto the full mesh before being plotted.

See Also
--------
pycafe.post_processing.post_processing : Forced-response post-processing.
"""
